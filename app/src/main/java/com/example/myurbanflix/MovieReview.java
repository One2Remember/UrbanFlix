...
public class MovieReview {
    ...
    public MovieReview(String revName, String mName, String un, String date, String cont, boolean uVote) {
        reviewTitle = revName;
        movieName = mName;
        userName = un;
        dateCreated = date;
    ...
    public static ArrayList<MovieReview> GenerateReviewList() {
        ...
        movieList.add(new MovieReview("Yes", "The Emoji Movie", "gofurkle", "4/11/2020", "Wow.", true));
        movieList.add(new MovieReview("No", "Free Willy", "one2remember", "4/11/2020", "MJ is a treasure.", false));
        movieList.add(new MovieReview("GOAT", "Pan's Labyrinth", "one2remember", "4/11/2020", "GOAT", true));
        return movieList;
    }
}
